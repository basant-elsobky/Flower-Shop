    ...
    < >
      <Swiper loop={true} navigation={true} modules={[Navigation]} className="mySwiper">
        <SwiperSlide className='slide1'  >
          <div >
            <h2 >find your own <br></br> happiness <span><img src='/images/leafes.webp' alt='' /></span></h2>

            <p  >the best gift for those you love.fresh flower delivery <br></br> daily and around a clock</p>
            <Link href='/Collection' className="shopnow">
        ...
        <SwiperSlide className='slide2'>
          <div className='flarsal'>
            <div className='innerflarsal  align-content-center align-items-center'>
              <h2>floral gala <span><img src='/images/leafes.webp' alt='' /></span></h2>
              <p>the best gift for those you love.fresh flower delivery <br></br> daily and around a clock</p>
              <Link href='/Collection' className="shopnow2">
